...
QR 分解 The QR Decomposition For Regression Models
http://mc-stan.org/users/documentation/case-studies/qr_regression.html

典型集和维数灾难 Typical Sets and the Curse of Dimensionality  待翻译
http://mc-stan.org/users/documentation/case-studies/curse-dims.html

重参数对点估计的影响 The Impact of Reparameterization on Point Estimates
http://mc-stan.org/users/documentation/case-studies/mle-params.html


池化作用 Hierarchical Partial Pooling for Repeated Binary Trials
http://mc-stan.org/users/documentation/case-studies/pool-binary-trials.html

弱信息先验如何影响推断 How the Shape of a Weakly Informative Prior Affects Inferences
